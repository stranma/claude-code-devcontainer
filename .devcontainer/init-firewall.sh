...
# plus any domains listed in firewall-domains.conf.
...
# Built-in domains for Python development with Claude Code
BUILTIN_DOMAINS=(
    "pypi.org"
...
ALL_DOMAINS=("${BUILTIN_DOMAINS[@]}" "${EXTRA_DOMAINS[@]}")
